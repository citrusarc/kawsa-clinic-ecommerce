  ...
  return (
    <div className="flex gap-2 items-center w-full sm:w-auto">
      <Button
        type="button"
        className={cn(
          "w-10 h-10 sm:w-12 sm:h-12 p-0 rounded-full cursor-pointer border border-neutral-200 text-neutral-600 bg-white hover:border-violet-600 hover:text-violet-600 hover:bg-violet-200",
